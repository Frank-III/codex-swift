public struct CodexSlashCommand: Hashable, Sendable {
  ...
  public static let builtins: [Self] = [
    ...
    Self("tree", "navigate this session's conversation tree", availableDuringTask: false),
    Self("rewind", "edit a prior prompt without discarding its branch", availableDuringTask: false),
